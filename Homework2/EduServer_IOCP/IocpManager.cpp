...
bool IocpManager::Initialize()
{
    ...
    if (SOCKET_ERROR == WSAIoctl(mListenSocket, SIO_GET_EXTENSION_FUNCTION_POINTER,
        &guidAcceptEx, sizeof(GUID), &lpfnAcceptex,
        sizeof(LPFN_ACCEPTEX), &dwBytes, nullptr, nullptr))
    {
    ...
    if (SOCKET_ERROR == WSAIoctl(mListenSocket, SIO_GET_EXTENSION_FUNCTION_POINTER,
        &guidDisconnectEx, sizeof(GUID), &lpfnDisconnectEx,
        sizeof(LPFN_DISCONNECTEX), &dwBytes, nullptr, nullptr))
    {
        printf("WSAIoctl error\n");
        return false;
    }
