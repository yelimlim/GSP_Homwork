...
private:
	...
	volatile long mLockFlag; //lock의 우선 순위
...
{
public:
	FastSpinlockGuard(FastSpinlock& lock, bool exclusive = true) : mLock(lock), mExclusiveMode(exclusive) //왜 여기에 bool exclusive = true로 되어 있지?
	{
		if (mExclusiveMode)
